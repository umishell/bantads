...
class RestExceptionHandler {
    ...
    fun notFound(ex: GerenteNaoEncontradoException) = respond(HttpStatus.NOT_FOUND, ex.message)
    ...
    fun generic(ex: Exception): ResponseEntity<ErrorResponse> {
        logger.error("Erro não tratado em ms-gerente", ex)
        return respond(HttpStatus.INTERNAL_SERVER_ERROR, "Erro interno no serviço de gerentes")
    }
