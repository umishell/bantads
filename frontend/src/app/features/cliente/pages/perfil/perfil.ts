...
export class PerfilComponent implements OnInit {
  ...
  protected carregarDados(): void {
    ...
    this.clienteService
      ...
      .subscribe({
        ...
        error: (error) => {
          this.errorMessage = error?.error?.message ?? 'Erro ao carregar dados do perfil.';
        },
      });
  }
  ...
  protected salvar(): void {
    ...
    this.salvando = true;
    const dadosAtualizados = this.perfilForm.getRawValue();
    ...
    this.clienteService
      ...
      .subscribe({
        next: () => {
          this.successMessage = 'Perfil atualizado com sucesso! O limite será recalculado se houve alteração salarial.';
        },
        error: (error) => {
